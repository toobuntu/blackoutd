...
# repro run sheet — 20260719-235246
...
```text
Run #: 87    started: 2026-07-19 23:52:46
...
Conditions (pre-sleep -> at capture):
  ...
  settle ................. 20 s
  daemon settled ......... 2026-07-19 23:53:23.686 blackoutd[26174:2796319] [wake] — display pipeline settled

Bundles:
  post-wake    = docs/debug/blackoutd-diag-20260719-235346
  post-recover = docs/debug/blackoutd-diag-20260719-235424
...
Notes: On AC power, did not hear the "Awake" announcement.
```
