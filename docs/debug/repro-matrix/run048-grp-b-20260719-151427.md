...
# repro run sheet — 20260719-151427
...
```text
Run #: 48    started: 2026-07-19 15:14:27
...
Conditions (pre-sleep -> at capture):
  ...
  settle ................. 20 s
  daemon settled ......... 2026-07-19 15:15:02.022 blackoutd[92781:2163480] [wake] — display pipeline settled

Bundles:
  post-wake    = docs/debug/blackoutd-diag-20260719-151501
  post-recover = docs/debug/blackoutd-diag-20260719-151540
...
Notes: R0 M1, wno visible or audible wake until clamshell reopened
```
