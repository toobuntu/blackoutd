...
# repro run sheet — 20260720-001020
...
```text
Run #: 92    started: 2026-07-20 00:10:20
...
Conditions (pre-sleep -> at capture):
  ...
  settle ................. 20 s
  daemon settled ......... 2026-07-20 00:10:56.427 blackoutd[26174:2796319] [wake] — display pipeline settled

Bundles:
  post-wake    = docs/debug/blackoutd-diag-20260720-001120
  post-recover = docs/debug/blackoutd-diag-20260720-001158
...
Notes: Did not hear the "Awake" cue. MCL not running.
```
