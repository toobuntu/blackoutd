...
# repro run sheet — 20260719-141825
...
```text
Run #: 37    started: 2026-07-19 14:18:25
...
Conditions (pre-sleep -> at capture):
  ...
  settle ................. 20 s
  daemon settled ......... 2026-07-19 14:18:45.191 blackoutd[87639:2064839] [wake] — display pipeline settled

Bundles:
  post-wake    = docs/debug/blackoutd-diag-20260719-141857
  post-recover = docs/debug/blackoutd-diag-20260719-141935
...
Notes: Music.app playing pre-sleep; went silent at sleep and resumed playing music prior to display wake.
```
