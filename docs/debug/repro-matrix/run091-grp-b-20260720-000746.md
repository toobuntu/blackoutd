...
# repro run sheet — 20260720-000746
...
```text
Run #: 91    started: 2026-07-20 00:07:46
...
Conditions (pre-sleep -> at capture):
  ...
  settle ................. 20 s
  daemon settled ......... 2026-07-20 00:08:23.489 blackoutd[26174:2796319] [wake] — display pipeline settled

Bundles:
  post-wake    = docs/debug/blackoutd-diag-20260720-000848
  post-recover = docs/debug/blackoutd-diag-20260720-000926
...
Notes: On AP power, MCL not running.
```
