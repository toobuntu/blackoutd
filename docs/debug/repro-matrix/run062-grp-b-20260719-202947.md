...
# repro run sheet — 20260719-202947
...
```text
Run #: 62    started: 2026-07-19 20:29:47
...
Conditions (pre-sleep -> at capture):
  ...
  settle ................. 20 s
  daemon settled ......... 2026-07-19 20:30:46.023 blackoutd[8558:2493339] [wake] — display pipeline settled

Bundles:
  post-wake    = docs/debug/blackoutd-diag-20260719-203059
  post-recover = docs/debug/blackoutd-diag-20260719-203137
...
Notes: Depressed trackpad to trigger wake; scheduled wake failed.
```
