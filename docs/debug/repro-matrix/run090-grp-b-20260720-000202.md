...
# repro run sheet — 20260720-000202
...
```text
Run #: 90    started: 2026-07-20 00:02:02
...
Conditions (pre-sleep -> at capture):
  ...
  settle ................. 20 s
  daemon settled ......... 2026-07-20 00:02:36.536 blackoutd[26174:2796319] [wake] — display pipeline settled

Bundles:
  post-wake    = docs/debug/blackoutd-diag-20260720-000301
  post-recover = docs/debug/blackoutd-diag-20260720-000339
...
Notes: On AC power, MonitorControlLite not running.
```
