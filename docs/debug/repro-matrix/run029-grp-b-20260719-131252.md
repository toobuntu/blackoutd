...
# repro run sheet — 20260719-131252
...
```text
Run #: 29    started: 2026-07-19 13:12:52
...
Conditions (pre-sleep -> at capture):
  ...
  settle ................. 20 s
  daemon settled ......... 2026-07-19 13:13:10.635 blackoutd[80240:1872712] [wake] — display pipeline settled

Bundles:
  post-wake    = docs/debug/blackoutd-diag-20260719-131324
  post-recover = docs/debug/blackoutd-diag-20260719-131404
...
Notes: Displays active, no recovery needed
```
