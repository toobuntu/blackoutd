...
# repro run sheet — 20260719-150805
...
```text
Run #: 45    started: 2026-07-19 15:08:05
...
Conditions (pre-sleep -> at capture):
  ...
  settle ................. 20 s
  daemon settled ......... 2026-07-19 15:08:24.438 blackoutd[92781:2163480] [wake] — display pipeline settled

Bundles:
  post-wake    = docs/debug/blackoutd-diag-20260719-150837
  post-recover = docs/debug/blackoutd-diag-20260719-150915
...
Notes: No recovery needed, music on
```
