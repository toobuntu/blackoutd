...
# repro run sheet — 20260719-205745
...
```text
Run #: 69    started: 2026-07-19 20:57:45
...
Conditions (pre-sleep -> at capture):
  ...
  settle ................. 20 s
  daemon settled ......... 2026-07-19 20:58:36.390 blackoutd[12629:2559119] [wake] — display pipeline settled

Bundles:
  post-wake    = docs/debug/blackoutd-diag-20260719-205849
  post-recover = docs/debug/blackoutd-diag-20260719-205935
...
Notes: Scheduled wake failed, wake manually triggered (W1).
```
