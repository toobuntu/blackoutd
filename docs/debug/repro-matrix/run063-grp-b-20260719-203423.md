...
# repro run sheet — 20260719-203423
...
```text
Run #: 63    started: 2026-07-19 20:34:23
...
Conditions (pre-sleep -> at capture):
  ...
  settle ................. 20 s
  daemon settled ......... 2026-07-19 20:35:28.255 blackoutd[8558:2493339] [wake] — display pipeline settled

Bundles:
  post-wake    = docs/debug/blackoutd-diag-20260719-203541
  post-recover = docs/debug/blackoutd-diag-20260719-203619
...
Notes: Scheduled wake failed; depressed Space bar to trigger wake.
```
