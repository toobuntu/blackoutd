...
# repro run sheet — 20260719-203715
...
```text
Run #: 64    started: 2026-07-19 20:37:15
...
Conditions (pre-sleep -> at capture):
  ...
  settle ................. 20 s
  daemon settled ......... 2026-07-19 20:38:09.271 blackoutd[8558:2493339] [wake] — display pipeline settled

Bundles:
  post-wake    = docs/debug/blackoutd-diag-20260719-203822
  post-recover = docs/debug/blackoutd-diag-20260719-203900
...
Notes: Scheduled wake failed; manual wake via depressing Space bar.
```
