...
# repro run sheet — 20260719-122934
...
```text
Run #: 27    started: 2026-07-19 12:29:34
...
Conditions (pre-sleep -> at capture):
  ...
  settle ................. 20 s
  daemon settled ......... 2026-07-19 12:29:53.101 blackoutd[80240:1872712] [wake] — display pipeline settled

Bundles:
  post-wake    = docs/debug/blackoutd-diag-20260719-123006
  post-recover = docs/debug/blackoutd-diag-20260719-123051
...
Notes: Displays active, recovery not needed. It took a few moments for the external display to be lit, showing desktop after the built-in blacked out.
```
