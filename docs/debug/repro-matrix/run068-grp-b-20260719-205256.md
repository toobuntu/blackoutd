...
# repro run sheet — 20260719-205256
...
```text
Run #: 68    started: 2026-07-19 20:52:56
...
Conditions (pre-sleep -> at capture):
  ...
  settle ................. 20 s
  daemon settled ......... 2026-07-19 20:53:50.045 blackoutd[8558:2493339] [wake] — display pipeline settled

Bundles:
  post-wake    = docs/debug/blackoutd-diag-20260719-205403
  post-recover = docs/debug/blackoutd-diag-20260719-205442
...
Notes: Scheduled wake failed; triggered by depressing touchpad.
```
