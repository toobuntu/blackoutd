...
# repro run sheet — 20260719-202401
...
```text
Run #: 61    started: 2026-07-19 20:24:01
...
Conditions (pre-sleep -> at capture):
  ...
  settle ................. 20 s
  daemon settled ......... 2026-07-19 20:25:25.305 blackoutd[8558:2493339] [wake] — display pipeline settled

Bundles:
  post-wake    = docs/debug/blackoutd-diag-20260719-202538
  post-recover = docs/debug/blackoutd-diag-20260719-202616
...
Notes: M0. NOTE: Scheduled wake failed; I had to depress the Space bar to wake.
```
