...
# repro run sheet — 20260719-152300
...
```text
Run #: 51    started: 2026-07-19 15:23:00
...
Conditions (pre-sleep -> at capture):
  ...
  settle ................. 20 s
  daemon settled ......... 2026-07-19 15:23:19.909 blackoutd[92781:2163480] [wake] — display pipeline settled

Bundles:
  post-wake    = docs/debug/blackoutd-diag-20260719-152332
  post-recover = docs/debug/blackoutd-diag-20260719-152410
...
Notes: M1. Physically unplug/replug the external display's USB-C side of its USB-C -> HDMI cable from the Macbook prior to the run (C1)
```
