...
# repro run sheet — 20260719-203953
...
```text
Run #: 65    started: 2026-07-19 20:39:53
...
Conditions (pre-sleep -> at capture):
  ...
  settle ................. 20 s
  daemon settled ......... 2026-07-19 20:40:43.411 blackoutd[8558:2493339] [wake] — display pipeline settled

Bundles:
  post-wake    = docs/debug/blackoutd-diag-20260719-204057
  post-recover = docs/debug/blackoutd-diag-20260719-204135
...
Notes: Scheduled wake failed; manual wake triggered by depressing Space bar.
```
