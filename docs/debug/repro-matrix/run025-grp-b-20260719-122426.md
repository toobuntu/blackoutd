...
# repro run sheet — 20260719-122426
...
```text
Run #: 25    started: 2026-07-19 12:24:26
...
Conditions (pre-sleep -> at capture):
  ...
  settle ................. 20 s
  daemon settled ......... 2026-07-19 12:24:45.144 blackoutd[80240:1872712] [wake] — display pipeline settled

Bundles:
  post-wake    = docs/debug/blackoutd-diag-20260719-122458
  post-recover = docs/debug/blackoutd-diag-20260719-122541
...
Notes: Displays active; recovery was not necessary but occurred anyway after some delay.
```
