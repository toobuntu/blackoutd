...
# repro run sheet — 20260719-121916
...
```text
Run #: 22    started: 2026-07-19 12:19:16
...
Conditions (pre-sleep -> at capture):
  ...
  settle ................. 20 s
  daemon settled ......... 2026-07-19 12:19:35.597 blackoutd[80240:1872712] [wake] — display pipeline settled

Bundles:
  post-wake    = docs/debug/blackoutd-diag-20260719-121948
  post-recover = n/a
...
Notes: There were a few brief moments during the blackout  and switchover where both the built-in and external were cursor-on-black.
```
