...
# repro run sheet — 20260720-002550
...
```text
Run #: 97    started: 2026-07-20 00:25:50
...
Conditions (pre-sleep -> at capture):
  ...
  settle ................. 20 s
  daemon settled ......... 2026-07-20 00:26:26.458 blackoutd[26174:2796319] [wake] — display pipeline settled

Bundles:
  post-wake    = docs/debug/blackoutd-diag-20260720-002650
  post-recover = docs/debug/blackoutd-diag-20260720-002729
...
Notes: On AC power. MCL not running.
```
